...
public class TimedLemmingSwitch extends SwitchObject{
	private int duration;
	private long toggleTime = 0;


	public TimedLemmingSwitch(int x, int y, int w, int h, String name, TiledMap map,Properties args) throws SlickException {		
